" -----------------------------------------------------------------------------
" File: hayry.vim
" Description: Colorscheme inspired by gruvbox and srcery
" Author: rafael <https://rarafael.net>
" Source: https://github.com/rarafael/hayry
" Last Modified: 27th of September 2023
" -----------------------------------------------------------------------------
...
let s:gb.dark0_hard  = ['#080808', 234]     " 29-32-33
let s:gb.dark0       = ['#181818', 235]     " 40-40-40
let s:gb.dark0_soft  = ['#605040', 236]     " 50-48-47
let s:gb.dark1       = ['#2a2a2a', 237]     " 60-56-54
let s:gb.dark2       = ['#363636', 239]     " 80-73-69
let s:gb.dark3       = ['#444444', 241]     " 102-92-84
let s:gb.dark4       = ['#505050', 243]     " 124-111-100
let s:gb.dark4_256   = ['#606060', 243]     " 124-111-100

let s:gb.gray_245    = ['#928374', 245]     " 146-131-116
let s:gb.gray_244    = ['#928374', 244]     " 146-131-116

let s:gb.light0_hard = ['#f9f5d7', 230]     " 249-245-215
let s:gb.light0      = ['#f0e0d0', 229]     " 253-244-193
let s:gb.light0_soft = ['#ffe0c0', 228]     " 242-229-188
...
let s:gb.bright_red     = ['#e05050', 167]     " 251-73-52
let s:gb.bright_green   = ['#70c050', 142]     " 184-187-38
let s:gb.bright_yellow  = ['#e0d040', 214]     " 250-189-47
let s:gb.bright_blue    = ['#30a0f0', 109]     " 131-165-152
let s:gb.bright_purple  = ['#c05090', 175]     " 211-134-155
let s:gb.bright_aqua    = ['#60d090', 108]     " 142-192-124
let s:gb.bright_orange  = ['#fe8019', 208]     " 254-128-25

let s:gb.neutral_red    = ['#d01f20', 124]     " 204-36-29
let s:gb.neutral_green  = ['#207f30', 106]     " 152-151-26
let s:gb.neutral_yellow = ['#e0c010', 172]     " 215-153-33
let s:gb.neutral_blue   = ['#1070f0', 66]      " 69-133-136
let s:gb.neutral_purple = ['#a020c0', 132]     " 177-98-134
let s:gb.neutral_aqua   = ['#409070', 72]      " 104-157-106
...
hi! link PreCondit GruvboxOrange

" Generic constant
hi! link Constant GruvboxOrange
" Character constant: 'c', '/n'
hi! link Character GruvboxOrange
